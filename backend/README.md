...
## Project Structure
    ...
    ├── testapiautoteammem_109648  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammem_109648`
...
2. Clone this repo and `cd testapiautoteammem_109648`
